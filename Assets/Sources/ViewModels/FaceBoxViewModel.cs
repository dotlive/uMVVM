...
namespace Assets.Sources.ViewModels
{
    ...
    {
        private readonly BindableProperty<string> Name = new BindableProperty<string>();
        private readonly BindableProperty<int> Level = new BindableProperty<int>();
        private readonly BindableProperty<string> Face = new BindableProperty<string>();
        private readonly BindableProperty<Badge> Badge = new BindableProperty<Badge>();
